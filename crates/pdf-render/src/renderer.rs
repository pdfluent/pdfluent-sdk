...
use pdf_interpret::encode::EncodedShadingPattern;
use pdf_interpret::font::Glyph;
use pdf_interpret::pattern::Pattern;
use pdf_interpret::{
...
impl<'a> Device<'a> for Renderer {
    fn draw_image(&mut self, image: pdf_interpret::Image<'a, '_>, mut transform: Affine) {
