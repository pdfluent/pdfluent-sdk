...
#[allow(dead_code)]
// Unused since the licence exceptions were removed (#226): they were the only
// codes Java threw. Kept because `docs/error_catalogue.md` names a coded Java
// exception as the contract, and the next surface to adopt one needs the
// thrower rather than a second copy of it.
