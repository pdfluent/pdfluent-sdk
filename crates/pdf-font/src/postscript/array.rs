...
use crate::postscript::object;
use crate::postscript::reader::Reader;
use crate::postscript::string;
...
impl<'a> Array<'a> {
    ...
    /// Return a [`Scanner`](crate::postscript::Scanner) that iterates over the objects inside
    /// this array.
    pub fn objects(&self) -> crate::postscript::Scanner<'a> {
        crate::postscript::Scanner::new(self.data)
    }
}
