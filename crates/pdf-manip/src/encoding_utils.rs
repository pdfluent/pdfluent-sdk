...
pub(crate) fn glyph_name_to_char(name: &str) -> Option<char> {
    ...
    match name {
        ...
        "Lslash" => Some('\u{0141}'),
        "lslash" => Some('\u{0142}'),
        // Adobe/TeX mathematical names also used by built-in CFF encodings.
        "asteriskmath" => Some('\u{2217}'),
        "openbullet" => Some('\u{25E6}'),
        "prime" => Some('\u{2032}'),
        "circleplus" => Some('\u{2295}'),
        "circlemultiply" => Some('\u{2297}'),
        "equivalence" => Some('\u{2261}'),
        "similar" => Some('\u{223C}'),
        "approxequal" => Some('\u{2248}'),
        "arrowright" => Some('\u{2192}'),
        "arrowup" => Some('\u{2191}'),
        "arrowdown" => Some('\u{2193}'),
        "arrowboth" => Some('\u{2194}'),
        "similarequal" => Some('\u{2243}'),
        "proportional" => Some('\u{221D}'),
        "angbracketleft" => Some('\u{27E8}'),
        "angbracketright" => Some('\u{27E9}'),
        "lscript" => Some('\u{2113}'),
        "vector" => Some('\u{20D7}'),
