...
PDF to PowerPoint (`.pptx`) conversion for the [PDFluent](https://pdfluent.com) SDK.

This crate produces Office Open XML PresentationML output by mapping page-level
PDF content (text runs, images, vector graphics) onto editable PPTX slides.

## Status

Part of the PDFluent SDK. Source: <https://github.com/pdfluent/pdfluent-sdk>. See the workspace `NOTICE` file for the
per-crate licence matrix.
